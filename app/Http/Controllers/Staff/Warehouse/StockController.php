...
use App\Models\{StockMovement, RawMaterialBatches, Warehouse, Material};
...
class StockController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('pages.staff.warehouse.stock.index', compact('materials', 'warehouses'));
    }
    ...
    public function store(Request $request)
    {
        $data = $request->validate([
            ...
            'batch_code' => 'required|string|max:50|unique:raw_material_batches,batch_code',
